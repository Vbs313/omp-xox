// pi-xox v2: Unified entry point
// Imports and delegates to all 8 extensions in a single module.
// OMP auto-discovers this as the extension entry when loading from ~/.omp/agent/extensions/pi-xox/
...
export default function piXox(pi: ExtensionAPI) {
  pi.setLabel("pi-xox v2");
